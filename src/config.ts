...
export function loadConfig(): MonitorConfig {
  ...
  return {
    ...
    resendApiKey: process.env.MONITOR_RESEND_API_KEY ?? "",
    resendFromEmail: process.env.MONITOR_RESEND_FROM_EMAIL ?? "",
    resendApiBase: process.env.MONITOR_RESEND_API_BASE ?? "https://api.resend.com",
